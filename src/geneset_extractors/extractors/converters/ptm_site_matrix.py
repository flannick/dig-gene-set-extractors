...
from geneset_extractors.extractors.proteomics.ptm_site_matrix_workflow import (
    PTMMatrixWorkflowConfig,
    run_ptm_site_matrix_workflow,
)
...
def run(args) -> dict[str, object]:
    activate_runtime_context("ptm_site_matrix", getattr(args, "provenance_overlay_json", None))
    ...
    files = [
        input_file_record(args.ptm_matrix_tsv, "ptm_matrix_tsv"),
        input_file_record(args.sample_metadata_tsv, "sample_metadata_tsv"),
    ]
    if args.protein_matrix_tsv:
        files.append(input_file_record(args.protein_matrix_tsv, "protein_matrix_tsv"))
    ...
    cfg = PTMMatrixWorkflowConfig(
        ...
        ptm_matrix_tsv=args.ptm_matrix_tsv,
        ...
        protein_matrix_tsv=args.protein_matrix_tsv,
        ...
        protein_adjustment_run_mode=args.protein_adjustment_run_mode,
        ...
        emit_gene_topk_site_comparison=bool(args.emit_gene_topk_site_comparison),
        gene_topk_site_compare_to=int(args.gene_topk_site_compare_to),
