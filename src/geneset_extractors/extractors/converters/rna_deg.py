...
def run(args) -> dict[str, object]:
    ...
    cfg = DEGWorkflowConfig(
        ...
        gmt_mode=getattr(args, "gmt_mode", "standard"),
        gmt_top_n_per_direction=getattr(args, "gmt_top_n_per_direction", None),
        gmt_sort_by=getattr(args, "gmt_sort_by", "adj.P.Val"),
