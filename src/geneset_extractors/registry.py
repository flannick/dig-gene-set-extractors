...
CONVERTERS = {
    ...
    "calr_ontology_mapper": calr_ontology_mapper,
    "calr_profile_query": calr_profile_query,
    "catlas_accessible_genes": catlas_accessible_genes,
    "chipseq_peak": chipseq_peak,
    "encode_accessibility_contrast": encode_accessibility_contrast,
    "encode_accessible_genes": encode_accessible_genes,
    "encode_concordance": encode_concordance,
    "encode_gtex_concordance": encode_gtex_concordance,
    "encode_kd_regulon": encode_kd_regulon,
    "encode_regulon_contrast": encode_regulon_contrast,
    "interop_regulon_clinvar": interop_regulon_clinvar,
    "cnv_gene_extractor": cnv_gene_extractor,
    "drug_response_screen": drug_response_screen,
    "glygen_gtex": glygen_gtex,
    "glycomaturity_gtex": glycomaturity_gtex,
    "gtex_tissue_depleted": gtex_tissue_depleted,
    "gtex_tissue_enriched": gtex_tissue_enriched,
