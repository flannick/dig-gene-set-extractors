...
In the CLI implementation, ATAC outputs are generated over two independent axes:
\begin{itemize}[leftmargin=2em]
...
\end{itemize}
Each active contrast is evaluated for each selected linkage model, then downstream program-family transforms are applied to that linked score space.
