...
This note is designed to cross-reference the CLI documentation in \texttt{docs/rna-seq-to-geneset.md}.
...
The repo workflow command \texttt{omics2geneset workflows cnmf\_select\_k} reads the cNMF
