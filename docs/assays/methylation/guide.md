...
Theory and equations: `docs/assays/methylation/methods.tex`.
...
- ATAC guide: `docs/assays/atac/guide.md`
- RNA guide: `docs/assays/rnaseq/guide.md`
- methylation methods note: `docs/assays/methylation/methods.tex`
- methylation resources note: `docs/assays/methylation/resources.md`
