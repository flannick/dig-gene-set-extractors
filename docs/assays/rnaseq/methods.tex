...
\]
The downsampling is deterministic given a base seed and comparison identifier, and the selected sample IDs are written to audit artifacts. This mode intentionally rejects covariates, batch terms, and repeated-measures flags so the fit remains a simple auditable two-group analysis.
