...
This supplementary note provides the biological rationale and mathematical definitions for the components exposed as command line arguments in \texttt{omics2geneset}. Practical usage examples and full flag listings are in \texttt{docs/assays/atac/guide.md}. The two documents are designed to be read in either order.
